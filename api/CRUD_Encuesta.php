...
switch ($Peticion) {
    case 'POST':
        ...
        $Variable_Encuesta["Expediente"] = (isset($_POST["Expediente"]) && !empty($_POST["Expediente"])) ? $_POST["Expediente"] : 0;
        $Variable_Encuesta["Parte"] = (isset($_POST["Parte"]) && !empty($_POST["Parte"])) ? $_POST["Parte"] : 0;
        ...
        $Variable_Encuesta["Comentario"] = (isset($_POST["Comentario"]) && !empty($_POST["Comentario"])) ? $_POST["Comentario"] : 0;
